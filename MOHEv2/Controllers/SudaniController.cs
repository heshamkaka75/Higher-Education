...
{
    public class SudaniController : Controller
    {
        ...
        public async Task<ActionResult> Create(SudaniViewModel create)
        {
            using (var client = new HttpClient())
            {
                ...
                var postjob = await client.PostAsJsonAsync<SudaniViewModel>("sudani/create", create);
                var content = postjob.Content;
                ...
                if (postjob.IsSuccessStatusCode)
                {
                    ...
                    return RedirectToAction("Errorco", "Sudani");
                }
